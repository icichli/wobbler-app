document.addEventListener('DOMContentLoaded', () => {
  ...
  // для шаблона «Рыба» — только «Рыба Выгодно», для «Корона А5» — цвета Короны, для «Сорт недели» — цвета Сорта, для «А5» — цвета А5, для остальных — остальные фоны.
  ...
  const BG_BLACK_TEXT = ['bgother:ba.jpg', 'bgother:zhivoe.jpg', 'bgother:ryba_vygodno.png', 'bgother:sort_nedeli_yellow.jpg', 'sort_nedeli_yellow.jpg', 'bgother:a5.jpg', 'a5.jpg', 'bgother:a5_yellow.jpg', 'a5_yellow.jpg', 'bgother:a5_orange.jpg', 'a5_orange.jpg', 'bgother:a5_blue.jpg', 'a5_blue.jpg', 'bgother:a5_green.jpg', 'a5_green.jpg'];
        ...
        showItemQuickMenu(bgBtn, opts, currentBg(), (val) => {
          ...
          if (!val) {
            ...
            if (BG_BLACK_TEXT.indexOf(val) !== -1) {
              // Светлый фон (Б/А, Живое, Рыба Выгодно) → чёрный текст наименования/веса/цены.
  ...
  function onBgInputChange() {
    ...
    if (isMultiModeNow() && bgApplyMode === 'item') {
      ...
      it.bg = snap;
      it.bgCustomized = true;
      if (BG_BLACK_TEXT.indexOf(snap.bgImage) !== -1) {
        applyBaAutoColors(it);
      }
    } else {
      templateBg = snap;
