document.addEventListener('DOMContentLoaded', () => {
  ...
  const builtInPresets = {
    ...
    // «Корона А5»: крупный воблер 14,5×9,1 см с полями 4 мм под вырезание.
    ...
    korona_a5: {
      ...
      subtitleAlign: 'center',
      subtitle: '',
      headerBg: '#ffffff',     // белые поля 4 мм вокруг графики под вырезание
    ...
    // «А5»: воблер 14,5×4,5 см с полями 4 мм под вырезание.
    a5: {
      name: 'А5',
      widthCm: 14.5,
      heightCm: 4.5,
      ...
      headerHeight: 90,
      layout: 'full',
      borderMm: 4,             // белая рамка 4 мм вокруг графики (поля под вырезание)
      layerRotate: 0,
      titleFitFloor: 12,
      autofitTitleOnly: true,
      labelPos: {
