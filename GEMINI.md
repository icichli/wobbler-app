...
├── gen_bg_index.py                      # Python-генератор индекса фонов из папки «bg other»
├── bg_index.json                        # Индекс фонов для работы по HTTP-протоколу
...
├── bg other/                            # Дополнительные фоновые изображения
├── большое разрешение фонов/            # Исходники фонов высокого разрешения
└── *.jpg                                # Пресетные фоны в корне (dots_bg.jpg, ryba_bg.jpg, sneki_bg.jpg и др.)
```
